...
<html lang="en">
  ...
  <head>
    ...
    <title>Jerlyn's Portfolio</title>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="section-heading">
                <h2>Here are some <em>Basic Information</em> &amp;
                  <span>My Thoughts</span> on this website</h2>
                  <div class="line-dec"></div>
                  <p>please note that I am making the best out of this test portfolio</p>
              </div>
            </div>
  ...
  <div class="projects section" id="projects">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>My <em>Works</em> &amp; <span>Projects</span></h2>
            <div class="line-dec"></div>
            <p>If you are redirected on the top of the page that will indicate that there is no link attached. It will serve as a future project</p>
          </div>
        </div>
      </div> 
    </div>
          ...
          <div class="owl-features owl-carousel">
            <div class="item">
              ...
              <div class="down-content">
                <h4>open slot for future projects</h4>
        ...
        <div class="col-lg-12">
          <div class="main-content">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="section-heading">
                  <h2>Total progress of the <em>Website</em> &amp; My <span>Projects</span></h2>
                  <div class="line-dec"></div>
                  <p>The progress bars may change within time as soon as I finish my future projects and works</p>
                </div>
                <div class="skills">
                  <div class="skill-slide marketing">
                    <div class="fill"></div>
                    <h6>Website's Frontend code</h6>
                    <span>90%</span>
                  </div>
                  <div class="skill-slide digital">
                    <div class="fill"></div>
                    <h6>Website's Backend code</h6>
                    <span>70%</span>
                  </div>
                  <div class="skill-slide media">
                    <div class="fill"></div>
                    <h6>Projects listing</h6>
                    <span>95%</span>
                  </div>
                </div>
                <p class="more-info">Be informed that these statistics may change in time.</p>
              </div>
            </div>
          </div>
        </div>

              ...
              <div class="col-lg-8">
                <form id="contact-form" action="/lab3/ci4/public/comments" method="post">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="name" name="name" id="name" placeholder="Your First Name..." value="<?= set_value('name') autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="surname" name="surname" id="surname" placeholder="Your Surname..." value="<?= set_value('surname')  autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="text" name="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your E-mail..." value="<?= set_value('email') required="">
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="subject" name="subject" id="subject" placeholder="Subject..." value="<?= set_value('subject') autocomplete="on" >
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
                        <textarea name="message" id="message" placeholder="Your Message" value="<?= set_value('message')></textarea>
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
